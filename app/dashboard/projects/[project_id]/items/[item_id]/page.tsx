      ...
      <div className="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        <div className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">{versions.length} versions</p>
          </div>
              ...
              {versions.map((v) => {
                ...
                return (
                  <tr key={v.id} className="align-top hover:bg-gray-50 dark:hover:bg-gray-900">
                    ...
                    <td className="px-4 py-3 text-gray-700 dark:text-gray-300">{fmt(v.updated_at)}</td>
                    <td className="px-4 py-3 text-gray-700 whitespace-pre-wrap dark:text-gray-300">
