...
Test:
    ...
    - [x] view specific item version history
    - [x] update item (new version)
        - [x] fix "isCurrent in item info ui"
    - [x] view list of all user projects
    - [x] create new project
    - [] delete current project

    - [] run updates on main db structure wise and test dev:main also works
    ...
    main db update commands:
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS uq_projects_owner_name
